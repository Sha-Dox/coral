...
CORAL is a central dashboard at http://localhost:3456 that collects 
...
The webhook endpoint is: http://localhost:3456/api/webhook/[platform_name]
...
Context:
- CORAL is running at http://localhost:3456
...
- Webhook: http://localhost:3456/api/webhook/twitter
- Events to send:
...
[platform_name]:
  ...
  webhook:
    enabled: true
    url: "http://localhost:3456/api/webhook/[platform_name]"
...
1. Test with CORAL running:
   ...
   - Verify events appear at http://localhost:3456
...
4. **Config Format**:
   ...
   my_platform:
     ...
     webhook:
       enabled: true
       url: "http://localhost:3456/api/webhook/my_platform"
   ```
...
3. Check events: curl http://localhost:3456/api/events/[platform]
```
